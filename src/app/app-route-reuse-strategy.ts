/*
  By using Angular's "Route Reuse Strategy" we can save the state of a component when routing
  and avoid losing data when the component is destroyed and recreated again.
...
export class CustomReuseStrategy implements RouteReuseStrategy {
  ...
  shouldDetach(route: ActivatedRouteSnapshot): boolean {
    ...
    if (this.acceptedRoutes.indexOf(route.routeConfig.path) > -1) {
      ...
      return false; // will be ":publicId" when user navigates to result
    }
  }
